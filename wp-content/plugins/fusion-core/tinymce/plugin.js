                ...
                if(FusionShortcodes.dev == 'true') {
	                ...
	                btn.onRenderMenu.add(function (c, b)
					{
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_blog',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[blog number_posts="10" cat_slug="" exclude_cats="" title="yes" thumbnail="yes" excerpt="yes" excerpt_words="35" meta_all="yes" meta_author="yes" meta_categories="yes" meta_comments="yes" meta_date="yes" meta_link="yes" meta_tags="yes" paging="yes" scrolling="pagination" blog_grid_columns="3" strip_html="yes" layout="large"][/blog]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_map',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[map address="" type="roadmap, satellite, hybrid, terrain" width="100%" height="300px" zoom="14" scrollwheel="yes" scale="yes" zoom_pancontrol="yes" popup="yes"][/map]');
                            }
                        });
...
<td><strong>$10.00</strong></td> \
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_vimeo',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[vimeo id="Enter video ID (eg. 10145153)" width="600" height="350" autoplay="no" api_params=""]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_youtube',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[youtube id="Enter video ID (eg. Wq4Y7ztznKc)" width="600" height="350" autoplay="no" api_params=""]');
                            }
                        });
