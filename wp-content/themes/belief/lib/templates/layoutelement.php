...
endhtml
    ...
    <div class="standard-generic-field generic-field-header">
        ...
        <div class="generic-field generic-field-image-select element-type">
            ...
            <label>
                <?php echo __( 'People groups' , 'cosmotheme' );?>
    ...
    <div class="standard-generic-field generic-field-header option-delimiter_hint">
        ...
        <div class="generic-field generic-field-image-select delimiter-type">
            ...
            <label class="columns-3">
                <?php echo __( 'Doubleline-bold delimiter' , 'cosmotheme' );?>
                <input type="radio" value="doubleline-bold" name="<?php echo $this -> get_prefix();?>[delimiter_type]" <?php checked( $this -> delimiter_type, 'doubleline_bold' );?>>
            </label>
            <label class="columns-3">
                <?php echo __( 'Dashed delimiter' , 'cosmotheme' );?>
                <input type="radio" value="dashed" name="<?php echo $this -> get_prefix();?>[delimiter_type]" <?php checked( $this -> delimiter_type, 'dashed' );?>>
            </label>            
            <div class="clear"></div>
        </div>
        <div class="generic-label clear">
            <label>
                <?php 
        ...
        <div class="delimiter_color">
            ...
            <div class="generic-field delimiter_color_picker">
                <?php $iname = mt_rand(0,9999).'_delimiter_text_color'; ?>
                <input type="text" name="<?php echo $this->get_prefix();?>[delimiter_text_color]" style="width:80px;" id="pick_<?php echo $iname; ?>" op_name="<?php echo $iname; ?>" value="<?php echo $this->delimiter_text_color;?>"  />
...
<!--             <label>
    ...
    <div class="standard-generic-field generic-field-header hide_timeline_img-options">
        <div class="generic-label">
            <label>
                <?php echo __( 'Hide Timeline image', 'cosmotheme' );?>
            </label>
        </div>
        <div class="generic-field generic-field-image-select">
            <label>
                <?php echo __( 'Yes' , 'cosmotheme' );?>
                <input type="radio" value="yes" name="<?php echo $this -> get_prefix();?>[hide_timeline_img]" <?php checked( $this -> hide_timeline_img, 'yes' );?>>
            </label>
            <label>
                <?php echo __( 'No' , 'cosmotheme' );?>
                <input type="radio" value="no" name="<?php echo $this -> get_prefix();?>[hide_timeline_img]" <?php checked( $this -> hide_timeline_img, 'no' );?>>
            </label>
        </div>
    </div>
...
<!--                    <?php echo __( 'Large thumb 2' , 'cosmotheme' );?>
    ...
    <div class="standard-generic-field generic-field-header options-meta">
        <div class="generic-label">
            <label>
                <?php echo __( 'Show meta', 'cosmotheme' );?>
            </label>
        </div>
        <div class="generic-field generic-field-image-select">
            <a href="javascript:void(0);" class="has-popup enb_carousel">
                <label>
                    <?php echo __( 'Yes' , 'cosmotheme' );?>
                    <input type="radio" value="yes" name="<?php echo $this -> get_prefix();?>[meta]" <?php checked( $this -> meta, 'yes' );?>>
                </label>
                <label>
                    <?php echo __( 'No' , 'cosmotheme' );?>
                    <input type="radio" value="no" name="<?php echo $this -> get_prefix();?>[meta]" <?php checked( $this -> meta, 'no' );?>>
                </label>                
            </a>
        </div>
    </div>
    ...
    <div class="standard-generic-field generic-field-header options-orderby">
        ...
        <div class="generic-field generic-field-image-select">
            ...
            <a href="javascript:void(0);" class="has-popup <?php echo $disabled;?>">
                <label>
                    <?php echo __( 'Number of likes' , 'cosmotheme' );?>
