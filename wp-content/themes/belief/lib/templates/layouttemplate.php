    ...
    <header class="region">
        <div class="region-inside">
            <div class="region-header">
                ...
                <a class="edit-header edit-header-background edit-element has-popup">
                    <div class="popup">
            ...
            <div class="element-container">
                <div class="on-edit">
                    ...
                    <div class="panel the-settings generic-field">
                        ...
                        <div class="header_bg_settings">
                            <div class="generic-label">
                                <label><?php _e('Header background color','cosmotheme'); ?></label>
                            </div>

                            <?php $iname = mt_rand(0,9999).'_header_bg_color'; ?>
                            <input type="text" name="<?php echo $this->get_prefix();?>[header_bg_color]" id="pick_<?php echo $iname; ?>" op_name="<?php echo $iname; ?>" value="<?php echo $this -> header_bg_color;?>"  />
                            <a href="#" class="pickcolor hide-if-no-js" id="link_pick_<?php echo $iname; ?>"></a>
                            <div id="colorPickerDiv_<?php echo $iname; ?>" class="colorPickerDiv" style="z-index: 100; background:#eee; border:1px solid #ccc; position:absolute; display:none;"></div>

                            <div class="generic-label">
                                <label><?php _e('Set header background color opacity','cosmotheme'); ?></label>
                            </div>                        
                            <div class="generic-field slider_ui_bg_opacity">
                                <?php $slider_uiname = 'header_bg_opacity_' . mt_rand(0,9999); ?>
                                <div  class="input">
                                    <input  type="hidden" id="<?php echo $slider_uiname; ?>" class="slider_value" name="<?php echo $this->get_prefix();?>[header_bg_opacity]" value="<?php echo $this -> header_bg_opacity;?>" />
                                    <div class="ui_slider" data-val="<?php echo $this -> header_bg_opacity;?>" data-min="1" data-max="100" ></div> <span class="slider_val" ><?php echo $this -> header_bg_opacity;?></span>
                                    <div class="clear"></div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            <script>init_ui_slider('.ui_slider');</script>

                            <div class="generic-label">
                                <label><?php _e('Header text color','cosmotheme'); ?></label>
                            </div>

                            <?php $text_color = mt_rand(0,9999).'_header_text_color'; ?>
                            <input type="text" name="<?php echo $this->get_prefix();?>[header_text_color]" id="pick_<?php echo $text_color; ?>" op_name="<?php echo $text_color; ?>" value="<?php echo $this -> header_text_color;?>"  />
                            <a href="#" class="pickcolor hide-if-no-js" id="link_pick_<?php echo $text_color; ?>"></a>
                            <div id="colorPickerDiv_<?php echo $text_color; ?>" class="colorPickerDiv" style="z-index: 100; background:#eee; border:1px solid #ccc; position:absolute; display:none;"></div>
