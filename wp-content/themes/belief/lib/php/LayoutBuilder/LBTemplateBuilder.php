    ...
    class LBTemplateBuilder extends  LBRenderable{
        ...
        function list_singulars( $singulars, $name_sg, $name_pl, $inputName ){
            if( !is_wp_error( $singulars ) && is_array( $singulars ) && count( $singulars ) ){
                ...
                $last_key = end(array_keys($singulars));
        ...
        function list_teams(){
            $teams = get_terms( 'people-group', array( 'hide_empty' => false ) );
            $this -> list_terms( $teams, __( 'people', 'cosmotheme' ), __( 'teams', 'cosmotheme' ), 'teams' );
        }
