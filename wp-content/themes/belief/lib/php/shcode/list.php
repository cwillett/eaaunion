...
<table class="sh_code_tbl" id="tbl_list">
	<tr>
		...
		<td width=275px>
			...
			<div class="cosmo-unorderedlist " id="unordered_sample" style="display: none">
				<ul>
					<li class="<?php echo 'icon-add'; ?>">Here goes the list item</li>
				</ul>
			</div>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<select id="unordered_list" style="display: none; width:100px;">
				<?php 
				foreach ($ul_styles as $key => $list_style) {
					
					echo "<option value='$key'>$list_style</option>";
				}	
				?>
			</select>
		</td>
