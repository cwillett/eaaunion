	...
	class shcode{
        function contact( $attr , $content ){
            ...
            if( $show_contact ){
                ...
                $result .= '<div class=" contact-left-col">';
                ...
                $result .= '</p>';
                $result .= '</div>'; /*EOF contact-left-col */
 
                $result .= '<div class="contact-right-col">';
                $result .= '<p class="content_message comment-form-comment textarea">';
                $result .= '<label for="contact_message">';
                $result .=  __('Message (required)' , 'cosmotheme');
                $result .= '</label>';
                ...
                $result .= '</div>'; /*EOF contact-right-col */
    	...
    	static function add_unordered_list( $atts , $content ){
            ...
            $ul_styles = array('icon-add' => 'plus' ,'icon-play' => 'arrow','icon-fav' => 'star','icon-close' => 'cancel','icon-tick' => 'tick');
			*/
	
        	
            	return '<div class="cosmo-unorderedlist ">'.$content.'</div>';
    	...
    	static function add_quote( $atts , $content ){
            ...
            if(isset($atts['source']) && strlen(trim($atts['source'])) ) {
                $source = '<br/><strong class="cosmo-blockquote-source">- '.$atts['source'].'</strong>';
            } else {
                $source = '';
            } 
        	return '<div class="cosmo-blockquote '.$style.' '.$float.' "><p>'.$content.$source.'</p></div>';
        }
