<?php
    class like{
        ...
        function sim_likes(){
            global $wp_query;
            $paged      = isset( $_POST['page']) ? $_POST['page'] : exit;
            $wp_query = new WP_Query( array('posts_per_page' => 150 , 'post_type' => array('post','event'),  'paged' => $paged ) );
...
?>
                        <span
                            ...
                            class=" voteaction count <?php if( !like::can_vote( $post -> ID ) ){ echo "simplemodal-love"; }?>
                                    <?php
                            ...
                            <span class="like-<?php echo $post -> ID; ?>"><?php echo self::count( $post -> ID ); ?></span>
                            <?php } ?>
                        </span>
<?php
                    }
