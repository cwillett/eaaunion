...
endhtml;
                ...
                case 'user_defined_text' : {
                    ...
                    */
                    ...
                    $result .= '<input type="text" value="" class="custom-meta-name generic-record '.$unique_class.'" /> <input type="button" value="'.__('Add custom field','cosmotheme').'" onclick="add_cosmo_custom_field(\'custom_cosmo_meta\',\''.$group.'\', \''.$topic.'\')">';
                    break;
                }
