<?php
    class resources{
        ...
        function people_shcode(){
            self::CallBox( 'people_shcode' );
        }

        function people_format(){
            self::CallBox( 'people_format' );
        }

        function people_layout(){
            self::CallBox( 'people_layout' );
        }

        
        function testimonial_shcode(){
            self::CallBox( 'testimonial_shcode' );
        }

        function event_shcode(){
        ...
        function people_settings(){
            self::CallBox( 'people_settings' );
        }

        function addbox_people_settings(){
            self::CallBox( 'addbox_people_settings' );
        }
        ...
        function addbox_page_builder(){
            self::CallBox( 'addbox_page_builder' );
        }

        function addbox_post_builder(){
        ...
        function addbox_event_shcode(){
            self::CallBox( 'addbox_event_shcode' );
        }

        function addbox_people_shcode(){
            self::CallBox( 'addbox_people_shcode' );
        }

        function addbox_people_format(){
            self::CallBox( 'addbox_people_format' );
        }

        function addbox_people_layout(){
            self::CallBox( 'addbox_people_layout' );
        }
        
        function addbox_event_settings(){
            self::CallBox( 'addbox_event_settings' );
        }
        
        function addbox_event_layout(){
            self::CallBox( 'addbox_event_layout' );
        }

        function addbox_event_date(){
            self::CallBox( 'addbox_event_date' );
        }

        function addbox_event_info(){
            self::CallBox( 'addbox_event_info' );
        }

        function addbox_event_map(){
            self::CallBox( 'addbox_event_map' );
        }
        
        function addbox_testimonial_shcode(){
        ...
        function addbox_box_info(){
            self::CallBox( 'addbox_box_info' );
        }

        function addbox_banner_info(){
