<?php
    class widget_featured_posts extends WP_Widget {
        ...
        function widget_featured_posts() {
            $widget_ops = array( 'classname' => 'widget_tabber ' , 'description' => __( 'Popular posts' , 'cosmotheme' ) );
            $this -> WP_Widget( 'widget_cosmo_featured_posts' , _TN_ . ' : ' . __( 'Popular posts' , 'cosmotheme' ) , $widget_ops );
        }
