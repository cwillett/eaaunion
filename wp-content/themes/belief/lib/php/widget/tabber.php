    ...
    class widget_tabber extends WP_Widget {
        ...
        ?>
            ...
            <ul class="tabs-controller">
                ...
                ?>
                        <li><a class="active" href="#tabber_hot_posts_panel"><?php _e( 'popular' , 'cosmotheme' )?></a></li>
                    ...
                    <div id="tabber_hot_posts_panel" class="tab_menu_content tabs-container">
                        <?php
                            ...
                            if( $wp_query -> have_posts() ){
                                ...
                                echo '<p>' . __( 'Sorry, no popular posts found.' , 'cosmotheme' ) . '</p>';
                            }
                                        ...
                                        <div class="eight mobile-three columns">
                                            ...
                                            <div class="widget-meta st">
                                                <ul>
                                                    ...
                                                    ?>
                                                    <li class="time"><time datetime="<?php echo date('Y-m-d',strtotime($comment -> comment_date)); ?>"><?php echo $comment_time; ?></time></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </article>
            ...
            <div id="tabber_tags_posts_panel" class="tab_menu_content tabs-container">
                <?php
                    ...
                    if( !empty( $tags ) && is_array( $tags ) ){
                        echo '<ul class="entry-content-tag-list">';
                        foreach( $tags as $tag ){
                            $tag_link = get_tag_link( $tag -> term_id );
                            ?><li class="entry-content-tag-elem"><a rel="tag" href="<?php echo $tag_link ?>"> <?php echo $tag -> name; ?></a></li> <?php
                        }
                        echo '</ul>'; 
                    }else{
