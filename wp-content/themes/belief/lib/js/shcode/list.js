...
jQuery(document).ready(function() {
	...
	jQuery('#unordered_list').change(function() {
		...
		jQuery('#unordered_sample li').prop('class', jQuery('#unordered_list').val() );
	});
...
function insertList(){
	...
	if(jQuery('#list_type').val() == 'ordered_list'){
		...
		list_shcode = '[unordered_list ] <ul> <li class="'+jQuery('#unordered_list').val()+'">Here goes the list item</li> </ul>	[/unordered_list]'; 
	}
