...
function add_videojs_header(){
	...
	if($options['videojs_cdn'] == 'on') { //use the cdn hosted version
		...
		echo '
		<link href="' . get_template_directory_uri().'/videojs/videojs/video-js.min.css" rel="stylesheet" />
		<script src="' . get_template_directory_uri().'/videojs/videojs/video.min.js"></script>		';
	}
}
