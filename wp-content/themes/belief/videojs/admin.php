...
function videojs_settings() {
	if (!current_user_can('manage_options'))  {
		wp_die( __('You do not have sufficient permissions to access this page.','cosmotheme') );
	}
	?>
	<div class="wrap">
	...
	?>
	<p class="submit">
	<input type="submit" class="button-primary" value="<?php _e('Save Changes','cosmotheme') ?>" />
	</p>
	</form>
	</div>
	<?php
